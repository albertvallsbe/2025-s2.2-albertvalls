...
const validate = () => {
    ...
    const formLastName = document.getElementById('fLastN');
    const formEmail = document.getElementById('fEmail');
    const formAddress = document.getElementById('fAddress');
    const formPhone = document.getElementById('fPhone');
    const formPassword = document.getElementById('fPassword');
    // Get the error elements
    const errorFirstName = document.getElementById('errorName');
    const errorLastName = document.getElementById('errorName');
    ...
    const markInvalid = (input, errorDiv) => {
    ...
    // Email
    if (formEmail.value.trim().length < 3 ||
    ...
    // Telèfon
    if (!onlyDigits.test(formPhone.value.trim()) ||
